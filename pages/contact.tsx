          ...
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0">
              ...
              <p className="mt-1 text-sm">
                Something, something, something, contact me.
              </p>
              <div className="flex gap-2 pt-3 pb-3">
                ...
                <p>rcrozean@gmail.com</p>
              </div>
              <div className="grid grid-cols-3 gap-3">
                <ExternalLink href="https://www.github.com/rcrozean">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                  ...
                  <div>
                    ...
                    <div className="mt-1">
                      <textarea
                        ...
                        rows={3}
                        className="mt-1 block w-full rounded border shadow-sm sm:text-sm"
                        placeholder="Please leave a message with your name and perferred method of contact."
                        defaultValue={''}
                      />
                    </div>
                  </div>
